...
class RequestHandler(BaseHTTPRequestHandler):
    ...
    def register(self):
        ...
        if not username or not nama or not password:
            ...
            response = {
                "status": "error",
                "message": "Username, nama, and password harus diisi"
            }
            self.wfile.write(
                json.dumps(response).encode()
            )
        ...
        try:
            ...
            cursor.execute(
                "INSERT INTO users (username, nama, password) VALUES (%s, %s, %s)",
    ...
    def login(self):
        ...
        if not username or not password:
            ...
            response = {
                "status": "error",
                "message": "Username and password harus diisi"
            }
            self.wfile.write(
                json.dumps(response).encode()
            )
        ...
        try:
            ...
            cursor = db.cursor()
            cursor.execute(
                "SELECT id, username, password, nama FROM users WHERE username = %s AND password = %s",
                (username, password)
            )
    ...
    def submit_puisi(self):
        ...
        if not judul or not isi or not kategori:
            ...
            response = {
                "status": "error",
                "message": "Judul, isi, dan kategori puisi harus diisi"
            }
            self.wfile.write(
                json.dumps(response).encode()
            )
        ...
        try:
            ...
            cursor = db.cursor()
            cursor.execute(
                "INSERT INTO puisi (user_id, judul, tgl_submit, isi, kategori, keyword) VALUES (%s, %s, CURDATE(), %s, %s, %s)",
                (user_id, judul, isi, kategori, keyword)
            )
            db.commit()
            cursor.close()
            db.close()
            ...
            response = {
                "status": "success",
                "message": "Puisi berhasil disubmit"
            }
            self.wfile.write(
                json.dumps(response).encode()
            )
    ...
    def daftar_puisi(self):
        ...
        try:
            ...
            cursor.execute(
                "SELECT id, judul, tgl_submit, isi, kategori, keyword FROM puisi WHERE user_id = %s ORDER BY tgl_submit DESC",
                (user_id,)
            )
    ...
    def logout(self):
        ...
        if session_token is None:
            ...
            response = {
                "status": "error",
                "message": "Belum login atau session token tidak valid"
            }
            self.wfile.write(
                json.dumps(response).encode()
            )
